...
public class GobbyAxe : MonoBehaviour
{
    ...
    private void Patrol()
    {
        ...
        if (enemyController.isFacingRight && !isTurning)
        {
        ...
        else if (!enemyController.isFacingRight && !isTurning)
        {
    ...
    {
        Vector2 offset = enemyController.isFacingRight
        ...
        Collider2D collider = Physics2D.OverlapBox(
            ...
            new Vector2(chaseDetectorSize.x, chaseDetectorSize.y),
            0f,
            playerLayer
        );
    ...
    private void OnDrawGizmos()
    {
        ...
        Vector3 offset = enemyController.isFacingRight
            ? chaseDetectorOriginOffset
            : new Vector2(-chaseDetectorOriginOffset.x, chaseDetectorOriginOffset.y);
        Gizmos.DrawWireCube(
            chaseDetectionZoneOrigin.position + offset,
            new Vector3(
                chaseDetectorSize.x * (enemyController.isFacingRight ? 1 : -1),
                chaseDetectorSize.y,
                1f
            )
        );
